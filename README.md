...
| [docs/croisement-de-sources.md](docs/croisement-de-sources.md) | **une question qui croise deux sources** : le périmètre que le tour désigne, pourquoi le plan portait déjà l'information qu'on jetait, les trois chemins pesés, et les clés étrangères sans lesquelles le modèle invente ses jointures |
